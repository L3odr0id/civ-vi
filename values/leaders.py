...
# Лидеры
_Alexandr_Makedonia = Leader('Александр', 'Македония', 0)
...
_Jhon_Cartin = Leader('Джон Кэртин', 'Австралия', 12)
...
_Konstantin_Ostrog = Leader('Константин Острожский', 'Волынь', 19)
...
_Saladin = Leader('Саладин', 'Аравия', 34)
_Simon_Bolivar = Leader('Симон Боливар', 'Колумбия', 35)
_Sondok = Leader('Сондок', 'Корея', 36)
_Suleiman = Leader('Сулейман', 'Османы', 37)
...
_Hammurapi = Leader('Хаммурапи', 'Вавилон', 47)
...
_Tin_Huan = Leader('Цинь Шихуанди', 'Китай', 52)
